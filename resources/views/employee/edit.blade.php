...
@section('content')
<section class="employee-update">
    <h1>Update Employee</h1>
    
    <div class="card">
        <div class="card-body">
            <form action="{{ route('employee.update', $employee->id) }}" method="POST" class="dropzone" id="employeeForm">
                @csrf
                @method('PUT')
                ...
                <div class="regular-form">
                    ...
                    <div class="form-group">
                        ...
                        <select name="position" id="position" class="form-control position2" required>
                            @if(!in_array($employee->position, ['System Architect', 'Developer', 'Designer']) && $employee->position)
                                <option value="{{ $employee->position }}" selected>{{ $employee->position }}</option>
                            @endif
                    
                            <option value="">Select Position</option>
                            <option value="System Architect" {{ $employee->position == 'System Architect' ? 'selected' : '' }}>System Architect</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="start_date" id="start_date" class="form-control datepicker" value="{{ old('start_date', $employee->start_date) }}" required>
                    </div>
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div id="dropzoneArea" class="dropzone-area">Drag n drop your profile picture here.<br></div>
                    </div>
    ...
    var myDropzone = new Dropzone("#dropzoneArea", {
        ...
        init: function() {
            ...
            this.on("sending", function(file, xhr, formData) {
                let formElements = $('#employeeForm').serializeArray();
